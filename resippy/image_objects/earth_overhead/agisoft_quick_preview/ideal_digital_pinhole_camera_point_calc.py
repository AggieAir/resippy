...
class IdealDigitalPinholeCameraPointCalc(AbstractEarthOverheadPointCalc):

    def __init__(self):
        super(IdealDigitalPinholeCameraPointCalc, self).__init__()
    ...
    def init_from_params(cls,
                         ...
                         yaw_degrees,
                         focal_length_mm,
                         pixel_pitch_x_microns,
                         npix_x,
                         npix_y,
                         flip_y=False,
                         flip_x=False,
                         ):                         # type: (...) -> IdealDigitalPinholeCameraPointCalc
        ...
        agisoft_quick_preview_point_calc = IdealDigitalPinholeCameraPointCalc()
